...
> = {
  ...
  meta: {
    modelProps: "user" | "userClaim" | "userToken";
...
export type UserClaimScalarFieldEnum =
  (typeof UserClaimScalarFieldEnum)[keyof typeof UserClaimScalarFieldEnum];
